...
from sqlalchemy import DateTime, ForeignKey, String, Enum, func, Uuid, Index
...
class CalendarEvent(Base):
    ...
    sync_action: Mapped[SyncAction] = mapped_column(Enum(SyncAction, name="sync_action", values_callable=lambda x: [e.value for e in x]), default=SyncAction.PUSH, nullable=False)
