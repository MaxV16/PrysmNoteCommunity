...
from sqlalchemy import Boolean, DateTime, ForeignKey, String, Text, func, Uuid, Index
...
class UserToken(Base):
    ...
    # Last time this token's calendar was pulled (background loop + manual
    # endpoint). Powers the background skip-guard and the manual rate limit.
