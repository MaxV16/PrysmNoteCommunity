...
PYRSM_FEATURE_GUIDE = (
    ...
    "TIMELINE SECTIONS: In the Timeline view, the Sections menu in the toolbar can "
    "split the row into nameable colored bands. Click the + handle to split at 50%, "
    "then rename a band and pick a rule (a list, tag, priority range or status). "
    "Tasks matching a band's rule are highlighted inside it, and dragging a task "
    "onto a band applies that rule to the task. Sections are a display layer: "
    "deleting a band never touches your tasks.\n\n"
