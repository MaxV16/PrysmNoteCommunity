...
PYRSM_FEATURE_GUIDE = (
    ...
    "TIMELINE SECTIONS: The Sections group in the sidebar organizes tasks into "
    "named sections (right-click a section to rename it, add one above or below, "
    "or delete it). In the Timeline view, the Sections toggle in the toolbar "
    "shows each section as a horizontal pill row: the tasks matching its rule "
    "(a list, tag, priority range or status, chosen from the funnel menu) appear "
    "as clickable chips. Sections are a display layer: deleting a section never "
    "touches your tasks.\n\n"
